...
public class GroupMember {
  ...
  public String toString() {
    return "GroupMember [groupNo=" + groupNo + ", memberNo=" + memberNo + ", regNo=" + regNo
        + ", register=" + register + ", photo=" + photo + ", birthday=" + birthday + ", name="
        + name + ", nickname=" + nickname + ", email=" + email + "]";
  }
