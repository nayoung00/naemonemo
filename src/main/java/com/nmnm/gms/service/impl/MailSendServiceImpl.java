...
//// + request.getContextPath() + "/app/member/key_alter?email=" + email + "&key=" + key
//// + "'>인증하기</a></p>" + "(혹시 잘못 전달된 메일이라면 이 이메일을 무시하셔도 됩니다)";
//// try {
//// mail.setSubject(String.format("[본인인증] Portfoli: %s님의 인증메일입니다", name), "utf-8");
...
// + "</h3><br><p><a href='http://localhost:9999/portfoli/'>Portfoli 바로가기</a><br>(혹시 잘못 전달된 메일이라면 이
// 이메일을 무시하셔도 됩니다)";
// try {
